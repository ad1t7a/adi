...
template <typename> void test_cuda_numext() {
...
template <typename> void test_cuda_conversion() {
  Eigen::CudaStreamDevice stream;
  Eigen::GpuDevice gpu_device(&stream);
  int num_elem = 101;
...
template <typename> void test_cuda_unary() {
  Eigen::CudaStreamDevice stream;
  Eigen::GpuDevice gpu_device(&stream);
  int num_elem = 101;
...
template <typename> void test_cuda_elementwise() {
  Eigen::CudaStreamDevice stream;
  Eigen::GpuDevice gpu_device(&stream);
  int num_elem = 101;
...
template <typename> void test_cuda_trancendental() {
  Eigen::CudaStreamDevice stream;
  Eigen::GpuDevice gpu_device(&stream);
  int num_elem = 101;
...
template <typename> void test_cuda_contractions() {
  Eigen::CudaStreamDevice stream;
  Eigen::GpuDevice gpu_device(&stream);
  int rows = 23;
  int cols = 23;
...
template <typename> void test_cuda_reductions(int size1, int size2, int redux) {
...
template <typename> void test_cuda_reductions() {
...
template <typename> void test_cuda_full_reductions() {
  Eigen::CudaStreamDevice stream;
  Eigen::GpuDevice gpu_device(&stream);
  int size = 13;
...
template <typename> void test_cuda_forced_evals() {
...
#else
  std::cout << "Half floats are not supported by this version of cuda: "
               "skipping the test"
            << std::endl;
#endif
}
