...
public:
  ...
  typedef Ref<
      Matrix<typename VectorType::Scalar, RowsAtCompileTime, ColsAtCompileTime>>
      Scalar;
  typedef typename BlockSparseMatrixT::Index Index;
...
public:
  ...
  BlockSparseMatrix(Index brow, Index bcol)
      : m_innerBSize(IsColMajor ? brow : bcol),
        m_outerBSize(IsColMajor ? bcol : brow), m_innerOffset(0),
        m_outerOffset(0), m_nonzerosblocks(0), m_values(0), m_blockPtr(0),
        m_indices(0), m_outerIndex(0), m_blockSize(BlockSize) {}
  ...
  BlockSparseTimeDenseProduct<BlockSparseMatrix, VecType>
  operator*(const VecType &lhs) const {
...
protected:
  ...
  StorageIndex *
      m_innerOffset; // Starting index of each inner block (size m_innerBSize+1)
  StorageIndex *
      m_outerOffset; // Starting index of each outer block (size m_outerBSize+1)
...
public:
  ...
  BlockInnerIterator(const BlockSparseMatrix &mat, const Index outer)
      : m_mat(mat), m_outer(outer), m_id(mat.m_outerIndex[outer]),
