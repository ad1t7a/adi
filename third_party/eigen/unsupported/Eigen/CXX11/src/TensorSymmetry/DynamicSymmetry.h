...
public:
  ...
  template <typename Gen_> inline void add(Gen_) {
...
private:
  ...
  h_permute(std::size_t which, const std::array<Index, N> &idx,
...
public:
  ...
  inline DynamicSGroupFromTemplateArgs(DynamicSGroupFromTemplateArgs &&other)
      : DynamicSGroup(other) {}
  inline DynamicSGroupFromTemplateArgs<Gen...> &
  operator=(const DynamicSGroupFromTemplateArgs<Gen...> &o) {
    DynamicSGroup::operator=(o);
    return *this;
  }
  inline DynamicSGroupFromTemplateArgs<Gen...> &
  operator=(DynamicSGroupFromTemplateArgs<Gen...> &&o) {
    DynamicSGroup::operator=(o);
    return *this;
  }
...
inline void DynamicSGroup::updateGlobalFlags(int flagDiffOfSameGenerator) {
  ...
  case (NegationFlag | ConjugationFlag):
     ...
     * generator causes the tensor to be real and the next one to be imaginary,
     * this will trivially give the correct result
     */
  }
}
