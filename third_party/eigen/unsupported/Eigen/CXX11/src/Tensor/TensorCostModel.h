...
public:
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorOpCost &
  operator+=(const TensorOpCost &rhs) {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE friend TensorOpCost
  operator+(TensorOpCost lhs, const TensorOpCost &rhs) {
    lhs += rhs;
    return lhs;
  }
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE friend TensorOpCost
  operator*(TensorOpCost lhs, double rhs) {
    lhs *= rhs;
    return lhs;
  }
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE friend TensorOpCost
  operator*(double lhs, TensorOpCost rhs) {
    rhs *= lhs;
    return rhs;
  }
...
public:
  ...
  numThreads(double output_size, const TensorOpCost &cost_per_coeff,
             int max_threads) {
  ...
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double
  taskSize(double output_size, const TensorOpCost &cost_per_coeff) {
    return totalCost(output_size, cost_per_coeff) / kTaskSize;
  }

private:
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE double
  totalCost(double output_size, const TensorOpCost &cost_per_coeff) {
