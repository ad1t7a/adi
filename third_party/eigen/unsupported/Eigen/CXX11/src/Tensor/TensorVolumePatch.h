...
public:
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorVolumePatchOp(
      ...
      : m_xpr(expr), m_patch_planes(patch_planes), m_patch_rows(patch_rows),
        m_patch_cols(patch_cols), m_plane_strides(plane_strides),
        m_row_strides(row_strides), m_col_strides(col_strides),
        m_in_plane_strides(in_plane_strides), m_in_row_strides(in_row_strides),
        m_in_col_strides(in_col_strides),
        m_plane_inflate_strides(plane_inflate_strides),
        m_row_inflate_strides(row_inflate_strides),
        m_col_inflate_strides(col_inflate_strides), m_padding_explicit(false),
        m_padding_top_z(0), m_padding_bottom_z(0), m_padding_top(0),
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorVolumePatchOp(
      ...
      : m_xpr(expr), m_patch_planes(patch_planes), m_patch_rows(patch_rows),
        ...
        m_plane_inflate_strides(plane_inflate_strides),
        m_row_inflate_strides(row_inflate_strides),
        m_col_inflate_strides(col_inflate_strides), m_padding_explicit(true),
        m_padding_top_z(padding_top_z), m_padding_bottom_z(padding_bottom_z),
...
struct TensorEvaluator<const TensorVolumePatchOp<Planes, Rows, Cols, ArgType>,
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorEvaluator(const XprType &op,
    ...
    if (op.padding_explicit()) {
      ...
      case PADDING_SAME: {
        ...
        const Index dz = m_outputPlanes * m_plane_strides + m_patch_planes_eff -
                         1 - m_input_planes_eff;
  ...
  evalSubExprsIfNeeded(Scalar * /*data*/) {
