...
public:
  ...
  EIGEN_DEVICE_FUNC
  EIGEN_STRONG_INLINE TensorReshapingOp &
  operator=(const TensorReshapingOp &other) {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorReshapingOp &
...
struct TensorEvaluator<const TensorSlicingOp<StartIndices, Sizes, ArgType>,
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorEvaluator(const XprType &op,
      ...
      : m_impl(op.expression(), device), m_device(device),
        m_dimensions(op.sizes()), m_offsets(op.startIndices()) {
...
public:
  ...
  EIGEN_DEVICE_FUNC
  EIGEN_STRONG_INLINE TensorStridingSlicingOp &
  operator=(const TensorStridingSlicingOp &other) {
