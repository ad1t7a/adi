...
void read_xy_file(const string &filename, vector<int> &tab_sizes,
                  vector<double> &tab_mflops);
void regularize_curve(const string &filename, const vector<double> &tab_mflops,
                      const vector<int> &tab_sizes, int start_cut_size,
                      int stop_cut_size);
/////////////////////////////////////////////////////////////////////////////////////////////////
...
int main(int argc, char *argv[]) {
  ...
  if (argc < 4) {
    INFOS("!!! Error ... usage : main filename start_cut_size stop_cut_size "
          "regularize_filename");
    exit(0);
  }
  INFOS(argc);
  ...
  regularize_curve(regularize_filename, tab_mflops, tab_sizes, start_cut_size,
                   stop_cut_size);
}
