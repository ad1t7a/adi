...
template <typename Kernel, typename Input, typename Output>
__global__ void run_on_cuda_meta_kernel(const Kernel ker, int n,
...
void run_on_cuda(const Kernel &ker, int n, const Input &in, Output &out) {
  ...
  cudaMemcpy(const_cast<typename Input::Scalar *>(in.data()), d_in, in_bytes,
...
template <typename Kernel, typename Input, typename Output>
void run_and_compare_to_cuda(const Kernel &ker, int n, const Input &in,
                             Output &out) {
