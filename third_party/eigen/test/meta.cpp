...
void test_meta() {
  ...
  VERIFY(
      (internal::is_same<internal::add_const<float &>::type, float &>::value));
  ...
  VERIFY((internal::is_same<const float, internal::remove_reference<
                                             const float &>::type>::value));
  VERIFY((internal::is_same<float,
                            internal::remove_pointer<float *>::type>::value));
  VERIFY((
