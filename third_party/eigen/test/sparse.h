 ...
 * MakeUpperTriangular allowing to control the shape of the matrix. \param
 * zeroCoords and nonzeroCoords allows to get the coordinate lists of the non
 * zero, and zero coefficients respectively.
 */
...
void initSparse(double density, Matrix<Scalar, Dynamic, Dynamic, Opt1> &refMat,
                ...
                int flags = 0, std::vector<Matrix<Index, 2, 1>> *zeroCoords = 0,
