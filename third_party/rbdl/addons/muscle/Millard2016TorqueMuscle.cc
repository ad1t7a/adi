...
const char *DataSet::names[] = {"Anderson2007", "Gymnast"};

const char *GenderSet::names[] = {"Male", "Female"};

const char *AgeGroupSet::names[] = {"Young18To25", "Middle55To65",
                                    "SeniorOver65"};
...
const char *Anderson2007::AgeGroupNames[] = {"Young18To25", "Middle55To65",
                                             "SeniorOver65"};

const char *Anderson2007::JointTorqueNames[] = {
    "HipExtension", "HipFlexion",     "KneeExtension",
...
double const Millard2016TorqueMuscle::Anderson2007Table3Mean[36][14] = {
    {0, 0, 0, 0, 0.161, 0.958, 0.932, 1.578, 3.19, 0.242, -1.21, -6.351, 0.476,
     5.91},
    {0, 0, 1, 0, 0.181, 0.697, 1.242, 1.567, 3.164, 0.164, -1.753, -6.358,
     0.239, 3.872},
    {0, 0, 0, 1, 0.171, 0.922, 1.176, 1.601, 3.236, 0.32, -2.16, -8.073, 0.108,
     4.593},
    {0, 0, 1, 1, 0.14, 0.83, 1.241, 1.444, 2.919, 0.317, -1.361, -7.128, 0.013,
     6.479},
    {0, 0, 0, 2, 0.144, 0.896, 1.125, 1.561, 3.152, 0.477, -2.671, -7.85, 0.092,
     5.192},
    {0, 0, 1, 2, 0.138, 0.707, 1.542, 1.613, 3.256, 0.36, -0.758, -7.545, 0.018,
     6.061},
    {0, 1, 0, 0, 0.113, 0.738, -0.214, 2.095, 4.267, 0.218, 1.21, -6.351,
     -0.476, 5.91},
    {0, 1, 1, 0, 0.127, 0.65, -0.35, 2.136, 4.349, 0.156, 1.753, -6.358, -0.239,
     3.872},
    {0, 1, 0, 1, 0.107, 0.712, -0.192, 2.038, 4.145, 0.206, 2.16, -8.073,
     -0.108, 4.593},
    {0, 1, 1, 1, 0.091, 0.812, -0.196, 2.145, 4.366, 0.186, 1.361, -7.128,
     -0.013, 6.479},
    {0, 1, 0, 2, 0.101, 0.762, -0.269, 1.875, 3.819, 0.296, 2.671, -7.85,
     -0.092, 5.192},
    {0, 1, 1, 2, 0.081, 0.625, -0.422, 2.084, 4.245, 0.196, 0.758, -7.545,
     -0.018, 6.061},
    {1, 0, 0, 0, 0.163, 1.258, 1.133, 1.517, 3.952, 0.095, 0, 0, -6.25, -4.521},
    {1, 0, 1, 0, 0.159, 1.187, 1.274, 1.393, 3.623, 0.173, 0, 0, -8.033, -5.25},
    {1, 0, 0, 1, 0.156, 1.225, 1.173, 1.518, 3.954, 0.266, 0, 0, -12.83,
     -5.127},
    {1, 0, 1, 1, 0.128, 1.286, 1.141, 1.332, 3.469, 0.233, 0, 0, -6.576,
     -4.466},
    {1, 0, 0, 2, 0.137, 1.31, 1.067, 1.141, 3.152, 0.386, 0, 0, -10.519,
     -5.662},
    ...
    {1, 1, 0, 2, 0.069, 0.838, 0.437, 1.718, 4.476, 0.414, 0, 0, 10.519,
     -5.662},
    {1, 1, 1, 2, 0.06, 0.897, 0.445, 1.121, 2.922, 0.389, 0, 0, 8.8, -6.763},
    {2, 0, 0, 0, 0.095, 1.391, 0.408, 0.987, 3.558, 0.295, -0.0005781, -5.819,
     0.967, 6.09},
    {2, 0, 1, 0, 0.104, 1.399, 0.424, 0.862, 3.109, 0.189, -0.005218, -4.875,
     0.47, 6.425},
    {2, 0, 0, 1, 0.114, 1.444, 0.551, 0.593, 2.128, 0.35, -0.001311, -10.943,
     0.377, 8.916},
    {2, 0, 1, 1, 0.093, 1.504, 0.381, 0.86, 3.126, 0.349, -2.888e-05, -17.189,
     0.523, 7.888},
    {2, 0, 0, 2, 0.106, 1.465, 0.498, 0.49, 1.767, 0.571, -5.693e-05, -21.088,
     0.488, 7.309},
    {2, 0, 1, 2, 0.125, 1.299, 0.58, 0.587, 1.819, 0.348, -2.35e-05, -12.567,
     0.331, 6.629},
    {2, 1, 0, 0, 0.033, 1.51, -0.187, 0.699, 1.94, 0.828, 0.0005781, -5.819,
     -0.967, 6.09},
    {2, 1, 1, 0, 0.027, 1.079, -0.302, 0.864, 2.399, 0.771, 0.005218, -4.875,
     -0.47, 6.425},
    {2, 1, 0, 1, 0.028, 1.293, -0.284, 0.634, 1.759, 0.999, 0.001311, -10.943,
     -0.377, 8.916},
    {2, 1, 1, 1, 0.024, 1.308, -0.254, 0.596, 1.654, 1.006, 2.888e-05, -17.189,
     -0.523, 7.888},
    {2, 1, 0, 2, 0.029, 1.419, -0.174, 0.561, 1.558, 1.198, 5.693e-05, -21.088,
     -0.488, 7.309},
    {2, 1, 1, 2, 0.022, 1.096, -0.369, 0.458, 1.242, 1.401, 2.35e-05, -12.567,
     -0.331, 6.629}};
...
double const Millard2016TorqueMuscle::Anderson2007Table3Std[36][14] = {
    {0, 0, 0, 0, 0.049, 0.201, 0.358, 0.286, 0.586, 0.272, 0.66, 0.97, 0.547,
     4.955},
    {0, 0, 1, 0, 0.047, 0.13, 0.418, 0.268, 0.542, 0.175, 1.93, 2.828, 0.292,
     1.895},
    {0, 0, 0, 1, 0.043, 0.155, 0.195, 0.306, 0.622, 0.189, 1.297, 2.701, 0.091,
     0.854},
    {0, 0, 1, 1, 0.032, 0.246, 0.365, 0.223, 0.45, 0.14, 1.294, 2.541, 0.02,
     2.924},
    {0, 0, 0, 2, 0.039, 0.124, 0.077, 0.184, 0.372, 0.368, 0.271, 3.402, 0.111,
     1.691},
    {0, 0, 1, 2, 0.003, 0.173, 0.279, 0.135, 0.273, 0.237, 0.613, 0.741, 0.031,
     2.265},
    {0, 1, 0, 0, 0.025, 0.217, 0.245, 0.489, 0.995, 0.225, 0.66, 0.97, 0.547,
     4.955},
    {0, 1, 1, 0, 0.033, 0.178, 0.232, 0.345, 0.702, 0.179, 1.93, 2.828, 0.292,
     1.895},
    {0, 1, 0, 1, 0.02, 0.248, 0.274, 0.318, 0.652, 0.088, 1.297, 2.701, 0.091,
     0.854},
    {0, 1, 1, 1, 0.016, 0.244, 0.209, 0.375, 0.765, 0.262, 1.294, 2.541, 0.02,
     2.924},
    {0, 1, 0, 2, 0.025, 0.151, 0.234, 0.164, 0.335, 0.102, 0.271, 3.402, 0.111,
     1.691},
    {0, 1, 1, 2, 0.008, 0.062, 0.214, 0.321, 0.654, 0.28, 0.613, 0.741, 0.031,
     2.265},
    ...
    {2, 0, 0, 0, 0.022, 0.089, 0.083, 0.595, 2.144, 0.214, 0.001193, 7.384,
     0.323, 1.196},
    {2, 0, 1, 0, 0.034, 0.19, 0.186, 0.487, 1.76, 0.213, 0.01135, 6.77, 0.328,
     1.177},
    {2, 0, 0, 1, 0.029, 0.136, 0.103, 0.165, 0.578, 0.133, 0.003331, 10.291,
     0.403, 3.119},
    {2, 0, 1, 1, 0.026, 0.235, 0.143, 0.448, 1.613, 0.27, 3.562e-05, 7.848,
     0.394, 1.141},
    {2, 0, 0, 2, 0.035, 0.136, 0.132, 0.262, 0.944, 0.313, 3.164e-05, 1.786,
     0.258, 0.902},
    {2, 0, 1, 2, 0.006, 0.095, 0.115, 0.258, 0.423, 0.158, 2.535e-05, 10.885,
     0.247, 2.186},
    {2, 1, 0, 0, 0.005, 0.19, 0.067, 0.108, 0.301, 0.134, 0.001193, 7.384,
     0.323, 1.196},
    {2, 1, 1, 0, 0.006, 0.271, 0.171, 0.446, 1.236, 0.206, 0.01135, 6.77, 0.328,
     1.177},
    {2, 1, 0, 1, 0.005, 0.479, 0.178, 0.216, 0.601, 0.214, 0.003331, 10.291,
     0.403, 3.119},
    {2, 1, 1, 1, 0.002, 0.339, 0.133, 0.148, 0.41, 0.284, 3.562e-05, 7.848,
     0.394, 1.141},
    {2, 1, 0, 2, 0.002, 0.195, 0.056, 0.188, 0.521, 0.29, 3.164e-05, 1.786,
     0.258, 0.902},
    {2, 1, 1, 2, 0.003, 0.297, 0.109, 0.089, 0.213, 0.427, 2.535e-05, 10.885,
     0.247, 2.186}};
...
double const Millard2016TorqueMuscle::GymnastWholeBody[22][12] = {
    {0, 0, 0, 0, 175.746, 9.02335, 1.06465, 1.05941, 1.1, 0.163849, 0.79158,
     1.5708},
    {0, 1, 0, 0, 157.293, 9.18043, 0.733038, 1.21999, 1.11905, 0.25, -0.0888019,
     -0.515207},
    {1, 0, 0, 0, 285.619, 19.2161, 0.942478, 0.509636, 1.13292, 0.115304,
     2.00713, 2.70526},
    {1, 1, 0, 0, 98.7579, 16.633, 1.02974, 1.11003, 1.12, 0.19746, 0,
     -0.174533},
    {2, 0, 0, 0, 127.561, 11.7646, 0.408, 0.660752, 1.159, 0.410591, 0.0292126,
     0.785398},
    {2, 1, 0, 0, 44.3106, 17.2746, -0.187, 0.60868, 1.2656, 0.112303, -0.523599,
     -1.0472},
    {3, 0, 0, 0, 127.401, 16.249, 2.14675, 1.83085, 1.1, 0.250134, 2.8291,
     3.55835},
    {3, 1, 0, 0, 91.1388, 19.0764, 0.890118, 1.2898, 1.23011, 0.249656,
     -0.523599, -1.0472},
    {5, 0, 0, 0, 15.5653, 36.5472, 1.55334, 1.38928, 1.16875, 0.115356, 1.0472,
     1.5708},
    {5, 1, 0, 0, 39.2252, 36.3901, 0.663225, 1.71042, 1.14, 0.115456, -0.793739,
     -1.49714},
    {3, 2, 0, 0, 128.496, 18.05, 0.839204, 1.28041, 1.25856, 0.214179, 1.5708,
     2.26893},
    {3, 3, 0, 0, 94.6839, 18, -0.277611, 2.37086, 1.23042, 0.224227, -0.523599,
     -1.0472},
    {3, 5, 0, 0, 50.522, 19.47, -1.18761, 2.80524, 1.27634, 0.285399, 1.39626,
     1.91986},
    {3, 4, 0, 0, 43.5837, 18, -0.670796, 1.98361, 1.35664, 0.229104, -1.0472,
     -1.5708},
    {4, 1, 0, 0, 101.384, 18.1, 0.33, 3.62155, 1.37223, 0.189909, 0, -0.174533},
    {4, 0, 0, 0, 69.8728, 18.45, 1.64319, 1.30795, 1.31709, 0.189676, 2.0944,
     2.61799},
    {5, 6, 0, 0, 13.5361, 35.45, -0.209204, 1.33735, 1.23945, 0.250544,
     -0.785398, -1.5708},
    {5, 7, 0, 0, 12.976, 27.88, -0.212389, 0.991803, 1.3877, 0.207506, 0.785398,
     1.5708},
    {5, 9, 0, 0, 31.4217, 18.02, 0.43, 1.47849, 1.34817, 0.196913, 0,
     -0.523599},
    {5, 8, 0, 0, 23.8345, 21.77, -1.14319, 2.56082, 1.31466, 0.2092, 0.349066,
     0.872665},
    {6, 0, 0, 0, 687.864, 7.98695, 1.5506, 1.14543, 1.1, 0.150907, 0.306223,
     1.35342},
    {6, 1, 0, 0, 211.65, 19.2310, 0, 6.28319, 1.1, 0.150907, 0, -0.785398}};

/*
 Original lumbar parameters
  {6,0,0,0,687.864, 1.0472,   1.5506,   1.14543,  1.1,     0.45,
 0.306223,  1.35342  }, {6,1,0,0,211.65 , 0.523599, 0,        6.28319,  1.1,
 0.45,      0,        -0.785398 }};
*/
...
const static struct JointSet {
  enum item { Hip = 0, Knee, Ankle, Shoulder, Elbow, Wrist, Lumbar, Last };
  JointSet() {}
} JointSet;
...
const static int JointTorqueMap[22][3] = {
    {(int)JointTorqueSet::HipExtension, (int)JointSet::Hip,
     (int)DirectionSet::Extension},
    {(int)JointTorqueSet::HipFlexion, (int)JointSet::Hip,
     (int)DirectionSet::Flexion},
    {(int)JointTorqueSet::KneeExtension, (int)JointSet::Knee,
     (int)DirectionSet::Extension},
    {(int)JointTorqueSet::KneeFlexion, (int)JointSet::Knee,
     (int)DirectionSet::Flexion},
    {(int)JointTorqueSet::AnkleExtension, (int)JointSet::Ankle,
     (int)DirectionSet::Extension},
    {(int)JointTorqueSet::AnkleFlexion, (int)JointSet::Ankle,
     (int)DirectionSet::Flexion},
    {(int)JointTorqueSet::ElbowExtension, (int)JointSet::Elbow,
     (int)DirectionSet::Extension},
    {(int)JointTorqueSet::ElbowFlexion, (int)JointSet::Elbow,
     (int)DirectionSet::Flexion},
    {(int)JointTorqueSet::ShoulderExtension, (int)JointSet::Shoulder,
     (int)DirectionSet::Extension},
    {(int)JointTorqueSet::ShoulderFlexion, (int)JointSet::Shoulder,
     (int)DirectionSet::Flexion},
    {(int)JointTorqueSet::WristExtension, (int)JointSet::Wrist,
     (int)DirectionSet::Extension},
    {(int)JointTorqueSet::WristFlexion, (int)JointSet::Wrist,
     (int)DirectionSet::Flexion},
    {(int)JointTorqueSet::ShoulderHorizontalAdduction, (int)JointSet::Shoulder,
     (int)DirectionSet::HorizontalAdduction},
    {(int)JointTorqueSet::ShoulderHorizontalAbduction, (int)JointSet::Shoulder,
     (int)DirectionSet::HorizontalAbduction},
    {(int)JointTorqueSet::ShoulderInternalRotation, (int)JointSet::Shoulder,
     (int)DirectionSet::InternalRotation},
    {(int)JointTorqueSet::ShoulderExternalRotation, (int)JointSet::Shoulder,
     (int)DirectionSet::ExternalRotation},
    {(int)JointTorqueSet::WristUlnarDeviation, (int)JointSet::Wrist,
     (int)DirectionSet::UlnarDeviation},
    {(int)JointTorqueSet::WristRadialDeviation, (int)JointSet::Wrist,
     (int)DirectionSet::RadialDeviation},
    {(int)JointTorqueSet::WristPronation, (int)JointSet::Wrist,
     (int)DirectionSet::Pronation},
    {(int)JointTorqueSet::WristSupination, (int)JointSet::Wrist,
     (int)DirectionSet::Supination},
    {(int)JointTorqueSet::LumbarExtension, (int)JointSet::Lumbar,
     (int)DirectionSet::Extension},
    {(int)JointTorqueSet::LumbarFlexion, (int)JointSet::Lumbar,
     (int)DirectionSet::Flexion}};
...
Millard2016TorqueMuscle::Millard2016TorqueMuscle()
    : angleOffset(1.0), signOfJointAngle(1.0), signOfJointTorque(1.0),
      signOfConcentricAnglularVelocity(1.0), muscleName("empty") {
...
Millard2016TorqueMuscle::Millard2016TorqueMuscle(
    DataSet::item dataSet, const SubjectInformation &subjectInfo,
    int jointTorque, double jointAngleOffsetRelativeToDoxygenFigures,
    double signOfJointAngleRelativeToDoxygenFigures, double signOfJointTorque,
    ...
    : angleOffset(jointAngleOffsetRelativeToDoxygenFigures),
      ...
      signOfConcentricAnglularVelocity(signOfJointTorque), muscleName(name),
      dataSet(dataSet) {
  ...
  if (joint == -1 || jointDirection == -1) {
    cerr << "Millard2016TorqueMuscle::"
         << "Millard2016TorqueMuscle:" << muscleName
         << ": A jointTorqueDirection of " << jointTorque << " does not exist.";
    assert(0);
    abort();
  }
  ...
  if (abs(abs(signOfJointTorque) - 1) > EPSILON) {
    cerr << "Millard2016TorqueMuscle::"
         << "Millard2016TorqueMuscle:" << muscleName
         << ": signOfJointTorque must be [-1,1] not " << signOfJointTorque;
    assert(0);
    abort();
  }
  ...
  if (subjectHeightInMeters <= 0) {
    cerr << "Millard2016TorqueMuscle::"
         << "Millard2016TorqueMuscle:" << muscleName
         << ": subjectHeightInMeters > 0, but it's " << subjectHeightInMeters;
    assert(0);
    abort();
  }
  ...
  if (subjectMassInKg <= 0) {
    cerr << "Millard2016TorqueMuscle::"
         << "Millard2016TorqueMuscle:" << muscleName
         << ": subjectMassInKg > 0, but it's " << subjectMassInKg;
    assert(0);
    abort();
  }
  ...
  case DataSet::Anderson2007: {
    ...
    for (int i = 0; i < 36; ++i) {
      ...
      if (abs(Anderson2007Table3Mean[i][jointIdx] - (double)joint) < EPSILON &&
          abs(Anderson2007Table3Mean[i][dirIdx] - (double)jointDirection) <
              EPSILON &&
          abs(Anderson2007Table3Mean[i][genderIdx] - (double)gender) <
              EPSILON &&
          abs(Anderson2007Table3Mean[i][ageIdx] - (double)ageGroup) < EPSILON) {
        idx = i;
      }
    }
  ...
  case DataSet::Gymnast: {
    ...
    for (int i = 0; i < JointTorqueSet::Last; ++i) {
      ...
      if (abs(GymnastWholeBody[i][jointIdx] - (double)joint) < EPSILON &&
          abs(GymnastWholeBody[i][dirIdx] - (double)jointDirection) < EPSILON &&
          abs(GymnastWholeBody[i][genderIdx] - (double)gender) < EPSILON &&
          abs(GymnastWholeBody[i][ageIdx] - (double)ageGroup) < EPSILON) {
        idx = i;
      }
    }
...
double Millard2016TorqueMuscle::calcJointTorque(double jointAngle,
  ...
  double jointTorque =
      ...
      (activation * ta * tv + tp * (1 - betaMax * fiberVelocityNorm));
...
double Millard2016TorqueMuscle::calcMaximumActiveIsometricTorqueScalingFactor(
    double jointAngle, double jointAngularVelocity, double activation,
  ...
  if (jointTorque * signOfJointTorque > SQRTEPSILON) {
    ...
    scaleFactor = maxActiveIsometricTorqueUpd / maxActiveIsometricTorque;
  }
  return scaleFactor;
}

void Millard2016TorqueMuscle::calcTorqueMuscleInfo(
    double jointAngle, double jointAngularVelocity, double activation,
  ...
  tmi.fiberTorque = tmi.fiberActiveTorque + tmi.fiberPassiveTorque;
  ...
  tmi.fiberStiffness = maxActiveIsometricTorque *
                       (activation * D_ta_DfiberAngle * tv + D_tp_DfiberAngle);

  // tmi.tendonStiffness      = std::numeric_limits<double>::infinity();
  tmi.jointStiffness =
      signOfJointTorque * tmi.fiberStiffness * D_fiberAngle_D_jointAngle;

  tmi.fiberActivePower = tmi.fiberActiveTorque * tmi.fiberAngularVelocity;
  tmi.fiberPassivePower = tmi.fiberPassiveTorque * tmi.fiberAngularVelocity;
  tmi.fiberPower = tmi.fiberActivePower + tmi.fiberPassivePower;
  // tmi.tendonPower        = 0.;
  ...
  tmi.DjointTorqueDactivation =
      signOfJointTorque * maxActiveIsometricTorque * (ta * tv);

  // Dtau_Domega = signTq*tauIso*(a * ta(theta) * Dtv_DthetaDot(thetaDot)*  )
  tmi.DjointTorqueDjointAngularVelocity =
      signOfJointTorque * maxActiveIsometricTorque *
      (activation * ta * D_tv_DfiberAngularVelocity *
           D_tv_DfiberAngularVelocity_D_jointAngularVelocity +
       D_tb_DfiberAngularVelocity);

  tmi.DjointTorqueDjointAngle = signOfJointTorque * maxActiveIsometricTorque *
                                (activation * D_ta_DfiberAngle * tv +
                                 D_tp_DfiberAngle + D_tb_DfiberAngle) *
...
double Millard2016TorqueMuscle::getJointTorqueSign() const {
  if (muscleCurvesAreDirty) {
    Millard2016TorqueMuscle *mutableThis =
        const_cast<Millard2016TorqueMuscle *>(this);
    mutableThis->updateTorqueMuscleCurves();
...
double Millard2016TorqueMuscle::getJointAngleSign() const {
  if (muscleCurvesAreDirty) {
    Millard2016TorqueMuscle *mutableThis =
        const_cast<Millard2016TorqueMuscle *>(this);
    mutableThis->updateTorqueMuscleCurves();
...
double Millard2016TorqueMuscle::getJointAngleOffset() const {
  if (muscleCurvesAreDirty) {
    Millard2016TorqueMuscle *mutableThis =
        const_cast<Millard2016TorqueMuscle *>(this);
    mutableThis->updateTorqueMuscleCurves();
...
double Millard2016TorqueMuscle::getNormalizedDampingCoefficient() const {
  if (muscleCurvesAreDirty) {
    Millard2016TorqueMuscle *mutableThis =
        const_cast<Millard2016TorqueMuscle *>(this);
    mutableThis->updateTorqueMuscleCurves();
...
void Millard2016TorqueMuscle::setNormalizedDampingCoefficient(double betaUpd) {
  if (betaUpd < 0) {
    cerr << "Millard2016TorqueMuscle::"
         << "setNormalizedDampingCoefficient:" << muscleName << "betaMax is "
         << betaUpd << " but betaMax must be > 0 " << endl;
    assert(0);
    abort();
  }
...
double Millard2016TorqueMuscle::getMaximumActiveIsometricTorque() const {
  if (muscleCurvesAreDirty) {
    Millard2016TorqueMuscle *mutableThis =
        const_cast<Millard2016TorqueMuscle *>(this);
    mutableThis->updateTorqueMuscleCurves();
...
double
Millard2016TorqueMuscle::getMaximumConcentricJointAngularVelocity() const {
  if (muscleCurvesAreDirty) {
    Millard2016TorqueMuscle *mutableThis =
        const_cast<Millard2016TorqueMuscle *>(this);
    mutableThis->updateTorqueMuscleCurves();
...
void Millard2016TorqueMuscle::setMaximumActiveIsometricTorque(
    double maxIsoTorque) {
  muscleCurvesAreDirty = true;
...
void Millard2016TorqueMuscle::setMaximumConcentricJointAngularVelocity(
  ...
  if (fabs(maxAngularVelocity) < SQRTEPSILON) {
    cerr << "Millard2016TorqueMuscle::"
         << "setMaximumJointAngularVelocity:" << muscleName
...
double
Millard2016TorqueMuscle::getJointAngleAtMaximumActiveIsometricTorque() const {
  if (muscleCurvesAreDirty) {
    Millard2016TorqueMuscle *mutableThis =
        const_cast<Millard2016TorqueMuscle *>(this);
    mutableThis->updateTorqueMuscleCurves();
...
double
Millard2016TorqueMuscle::getJointAngleAtOneNormalizedPassiveIsometricTorque()
    const {
  if (muscleCurvesAreDirty) {
    Millard2016TorqueMuscle *mutableThis =
        const_cast<Millard2016TorqueMuscle *>(this);
...
double Millard2016TorqueMuscle::getPassiveTorqueScale() const {
  if (muscleCurvesAreDirty) {
    Millard2016TorqueMuscle *mutableThis =
        const_cast<Millard2016TorqueMuscle *>(this);
    mutableThis->updateTorqueMuscleCurves();
...
void Millard2016TorqueMuscle::setPassiveTorqueScale(
    double passiveTorqueScaling) {
  muscleCurvesAreDirty = true;
...
void Millard2016TorqueMuscle::setPassiveCurveAngleOffset(
    double passiveCurveAngleOffsetVal) {
  muscleCurvesAreDirty = true;
  passiveCurveAngleOffset = passiveCurveAngleOffsetVal;
}

void Millard2016TorqueMuscle::fitPassiveCurveAngleOffset(
    double jointAngleTarget, double passiveTorqueTarget) {
  muscleCurvesAreDirty = true;
  setPassiveCurveAngleOffset(0.0);

  if (passiveTorqueTarget < SQRTEPSILON) {
    cerr << "Millard2016TorqueMuscle::"
         << "fitPassiveTorqueScale:" << muscleName << ": passiveTorque "
         << passiveTorqueTarget << " but it should be greater than sqrt(eps)"
         << endl;
    assert(0);
    abort();
  }
  ...
  while (iter < iterMax && abs(err) > tol) {
    ...
    errLeft = tqInfo.fiberPassiveTorqueAngleMultiplier - normPassiveTorque;

    calcTorqueMuscleInfo(jointAngleRight, 0., 0., tqInfo);
    errRight = tqInfo.fiberPassiveTorqueAngleMultiplier - normPassiveTorque;
  ...
  if (abs(err) > SQRTEPSILON) {
    cerr << "Millard2016TorqueMuscle::"
         << "fitPassiveCurveAngleOffset:" << muscleName
  ...
  double fiberAngleOffset =
      calcFiberAngle(jointAngleTarget) - calcFiberAngle(jointAngleCurr);

  setPassiveCurveAngleOffset(fiberAngleOffset);
}

void Millard2016TorqueMuscle::fitPassiveTorqueScale(
    double jointAngleTarget, double passiveTorqueTarget) {
  muscleCurvesAreDirty = true;
  ...
  if ((fiberAngle < curveDomain[0] && (curveRange[0] < curveRange[1])) ||
    ...
    cerr << "Millard2016TorqueMuscle::"
         << "fitPassiveTorqueScale:" << muscleName << ": joint angle is "
         << jointAngleTarget << " but it should be between "
         << calcJointAngle(curveDomain[0]) << " and "
         << calcJointAngle(curveDomain[1]) << endl;
    assert(0);
    abort();
  }
  ...
  if (abs(err) > SQRTEPSILON) {
    cerr << "Millard2016TorqueMuscle::"
         << "fitPassiveTorqueScale:" << muscleName
...
const SmoothSegmentedFunction &
Millard2016TorqueMuscle::getActiveTorqueAngleCurve() const {
...
const SmoothSegmentedFunction &
Millard2016TorqueMuscle::getPassiveTorqueAngleCurve() const {
  // This must be updated if the parameters have changed
  if (muscleCurvesAreDirty) {
    Millard2016TorqueMuscle *mutableThis =
        const_cast<Millard2016TorqueMuscle *>(this);
...
const SmoothSegmentedFunction &
Millard2016TorqueMuscle::getTorqueAngularVelocityCurve() const {
  // This must be updated if the parameters have changed
  if (muscleCurvesAreDirty) {
    Millard2016TorqueMuscle *mutableThis =
        const_cast<Millard2016TorqueMuscle *>(this);
...
string Millard2016TorqueMuscle::getName() { return muscleName; }
...
double Millard2016TorqueMuscle::calcFiberAngle(double jointAngle) const {
  return signOfJointAngle * (jointAngle - angleOffset);
}

double Millard2016TorqueMuscle::calcJointAngle(double fiberAngle) const {
  return fiberAngle * signOfJointAngle + angleOffset;
}

double Millard2016TorqueMuscle::calcFiberAngularVelocity(
...
void Millard2016TorqueMuscle::updateTorqueMuscleCurves() {
  ...
  case DataSet::Anderson2007: {
    ...
    scaleFactorAnderson2007 = subjectHeightInMeters * subjectMassInKg * gravity;

    if (useTabularMaxActiveIsometricTorque) {
      maxActiveIsometricTorque =
          scaleFactorAnderson2007 * c1c2c3c4c5c6Anderson2007[0];
    }

    angleAtOneNormActiveTorque = c1c2c3c4c5c6Anderson2007[2];

    TorqueMuscleFunctionFactory::createAnderson2007ActiveTorqueAngleCurve(
        c1c2c3c4c5c6Anderson2007[1], c1c2c3c4c5c6Anderson2007[2],
        tempName.append("_taCurve"), taCurve);

    tempName = muscleName;

    TorqueMuscleFunctionFactory::createAnderson2007ActiveTorqueVelocityCurve(
        c1c2c3c4c5c6Anderson2007[3], c1c2c3c4c5c6Anderson2007[4],
        c1c2c3c4c5c6Anderson2007[5], 1.1, 1.4, tempName.append("_tvCurve"),
        tvCurve);

    tempName = muscleName;

    double normMaxActiveIsometricTorque =
        maxActiveIsometricTorque / scaleFactorAnderson2007;

    TorqueMuscleFunctionFactory::createAnderson2007PassiveTorqueAngleCurve(
        scaleFactorAnderson2007, normMaxActiveIsometricTorque,
        b1k1b2k2Anderson2007[0], b1k1b2k2Anderson2007[1],
        b1k1b2k2Anderson2007[2], b1k1b2k2Anderson2007[3],
        tempName.append("_tpCurve"), tpCurve);
  ...
  case DataSet::Gymnast: {
    if (useTabularOmegaMax) {
      omegaMax = gymnastParams[Gymnast::OmegaMax];
    }
    if (useTabularMaxActiveIsometricTorque) {
      maxActiveIsometricTorque = gymnastParams[Gymnast::TauMax];
    }
    angleAtOneNormActiveTorque =
    ...
    TorqueMuscleFunctionFactory::createTorqueVelocityCurve(
        ...
        tempName.append("_tvCurve"), tvCurve);
  ...
  if (isfinite(angleAtOneNormPassiveTorque) &&
    ...
    while (abs(err) > SQRTEPSILON && iter < iterMax) {
      ...
      err = tpCurve.calcValue(angleAtOneNormPassiveTorque) - 1.0;
  ...
  TorqueMuscleFunctionFactory::createDampingBlendingCurve(
      -1.0, tempName.append("_dampingCurve"), betaCurve);

  muscleCurvesAreDirty = false;
}

void Millard2016TorqueMuscle::printJointTorqueProfileToFile(
    const std::string &path, const std::string &fileNameWithoutExtension,
  ...
  double jointDelta =
      (jointMax - jointMin) / ((double)numberOfSamplePoints - 1.);

  double velMin =
      omegaMax * signOfConcentricAnglularVelocity * velocityDomain[0];
  double velMax =
      omegaMax * signOfConcentricAnglularVelocity * velocityDomain[1];
  ...
  for (int i = 0; i < numberOfSamplePoints; ++i) {
    ...
    calcTorqueMuscleInfo(jointAngle, jointVelocity, activation, tmInfo);
