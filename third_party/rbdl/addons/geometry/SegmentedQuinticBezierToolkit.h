 ...
 */
  ...
  */
  static double
  calcQuinticBezierCurveVal(double u,
  ...
  */
  static double calcQuinticBezierCurveDerivU(
      double u, const RigidBodyDynamics::Math::VectorNd &pts, int order);
  ...
  */
  static double calcQuinticBezierCurveDerivDYDX(
      double u, const RigidBodyDynamics::Math::VectorNd &xpts,
      const RigidBodyDynamics::Math::VectorNd &ypts, int order);
...
private:
  ...
  */
  ...
  ///@cond
  /**
  Class that contains data that describes the Bezier curve set. This class is
  used by the function calcNumIntBezierYfcnX, which evaluates the numerical
  integral of a Bezier curve set.
  */
  class BezierData {
  public:
