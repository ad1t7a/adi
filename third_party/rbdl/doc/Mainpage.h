 ...
 * here:<br>
 *   <a
href="https://bitbucket.org/rbdl/rbdl/get/default.zip">https://bitbucket.org/rbdl/rbdl/get/default.zip</a>
 *
 * All development takes place on Bitbucket and you can follow RBDL's
 * development here:<br>
 *   <a
href="https://bitbucket.org/rbdl/rbdl">https://bitbucket.org/rbdl/rbdl</a>
 *
 * \section recent_changes Recent Changes
 * <ul>
 * <li>02 May 2018: New release 2.6.0:
 *   <ul>
 *     <li> Added support for closed-loop models by replacing Contacts API by a
new
 *       Constraints API. Loop constraints can be stabilized using Baumgarte
 *       stabilization. Special thanks to Davide Corradi for this
contribution!</li>
 *     <li> New constraint type CustomConstraint: a versatile interface to
define
 *       more general types of constraints (e.g. time dependent), contributed by
 *       Matthew J. Millard.</li>
 *     <li> New joint type JointTypeHelical that can be used for screwing
motions
 *       (translations and simultaneous rotations), contributed by Stuart
Anderson.</li>
 *     <li> Added support to specify external forces on bodies on constrained
forward
 *       dynamics and NonlinearEffects() (contributed by Matthew J.
Millard)</li>
 ...
 *     <li> Removed Model::SetFloatingBaseBody(). Use JointTypeFloatingBase
instead.</li>
 ...
 *   <ul>
 *     <li> Added an experimental Cython based Python wrapper of RBDL. The API
is
 *       very close to the C++ API. For a brief glimpse of the API see
 *       \ref PythonExample "Python Example"</li>
 *     <li> Matthew Millard added CustomJoints which allow to create different
joint
 ...
 *     <li> Added CalcMInvTimesTau() that evaluates multiplication of the
inverse of
 *       the joint space inertia matrix with a vector in O(n) time.</li>
 *     <li> Added JointTypeFloatingBase which uses TX,TY,TZ and a spherical
joint for
 *       the floating base joint.</li>
 *     <li> Loading of floating base URDF models must now be specified as a
third
 *       parameter to URDFReadFromFile() and URDFReadFromString()</li>
 *     <li> Added the URDF code from Bullet3 which gets used when ROS is not
found.
 *       Otherwise use the URDF libraries found via Catkin.</li>
 *     <li> Added CalcPointVelocity6D, CalcPointAcceleration6D, and
CalcPointJacobian6D
 ...
 *   <ul>
 *    <li>Added sparse range-space method
ForwardDynamicsContactsRangeSpaceSparse() and
ComputeContactImpulsesRangeSpaceSparse()</li>
 *    <li>Added null-space method ForwardDynamicsContactsNullSpace() and
ComputeContactImpulsesNullSpace()</li>
 *    <li>Renamed ForwardDynamicsContactsLagrangian() to
ForwardDynamicsContactsDirect() and ComputeContactImpulsesLagrangian() to
ComputeContactImpulsesDirect()</li>
 *    <li>Renamed ForwardDynamicsContacts() to
ForwardDynamicsContactsKokkevis()</li>
 *    <li>Removed/Fixed CalcAngularMomentum(). The function produced wrong
values. The functionality has been integrated into CalcCenterOfMass().</li>
 ...
 *    <li>Added JointTypeTranslationXYZ, JointTypeEulerXYZ, and
JointTypeEulerYXZ which are equivalent to the emulated multidof joints but
faster.</li>
 *    <li>Added optional parameter to CalcCenterOfMass() to compute angular
momentum.</li>
 ...
 *
 * Another example that uses the \ref addon_luamodel_page "LuaModel Addon" can
be found \ref
 ...
 *    title="RBDL: an efficient rigid-body dynamics library using recursive
algorithms",
