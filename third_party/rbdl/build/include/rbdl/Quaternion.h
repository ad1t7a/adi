...
/** \brief Quaternion that are used for \ref joint_singularities "singularity
 * free" joints.
 *
 * order: x,y,z,w
 */
...
public:
  ...
  Quaternion operator*(const double &s) const {
    return Quaternion((*this)[0] * s, (*this)[1] * s, (*this)[2] * s,
                      (*this)[3] * s);
  }
  /** This function is equivalent to multiplicate their corresponding rotation
   * matrices */
  Quaternion operator*(const Quaternion &q) const {
    return Quaternion((*this)[3] * q[0] + (*this)[0] * q[3] +
                          (*this)[1] * q[2] - (*this)[2] * q[1],
                      (*this)[3] * q[1] + (*this)[1] * q[3] +
                          (*this)[2] * q[0] - (*this)[0] * q[2],
                      (*this)[3] * q[2] + (*this)[2] * q[3] +
                          (*this)[0] * q[1] - (*this)[1] * q[0],
                      (*this)[3] * q[3] - (*this)[0] * q[0] -
                          (*this)[1] * q[1] - (*this)[2] * q[2]);
  }
  Quaternion &operator*=(const Quaternion &q) {
    set((*this)[3] * q[0] + (*this)[0] * q[3] + (*this)[1] * q[2] -
            (*this)[2] * q[1],
        (*this)[3] * q[1] + (*this)[1] * q[3] + (*this)[2] * q[0] -
            (*this)[0] * q[2],
        (*this)[3] * q[2] + (*this)[2] * q[3] + (*this)[0] * q[1] -
            (*this)[1] * q[0],
        (*this)[3] * q[3] - (*this)[0] * q[0] - (*this)[1] * q[1] -
            (*this)[2] * q[2]);
    return *this;
  }
  ...
  static Quaternion fromMatrix(const Matrix3d &mat) {
    ...
    return Quaternion((mat(1, 2) - mat(2, 1)) / (w * 4.),
                      (mat(2, 0) - mat(0, 2)) / (w * 4.),
  ...
  Quaternion timeStep(const Vector3d &omega, double dt) {
    ...
    return Quaternion::fromAxisAngle(omega / omega_norm, dt * omega_norm) *
           (*this);
  }
