...
public:
  ...
  EIGEN_STRONG_INLINE Vector3_t(const double &v0, const double &v1,
                                const double &v2) {
    Base::_check_template_params();
...
public:
  ...
  EIGEN_STRONG_INLINE Matrix3_t(const double &m00, const double &m01,
...
public:
  ...
  EIGEN_STRONG_INLINE Vector4_t(const double &v0, const double &v1,
...
class RBDL_TEMPLATE_DLLAPI SpatialVector_t
    : public Eigen::Matrix<double, 6, 1> {
public:
  ...
  EIGEN_STRONG_INLINE SpatialVector_t(const double &v0, const double &v1,
                                      const double &v2, const double &v3,
...
class RBDL_TEMPLATE_DLLAPI SpatialMatrix_t
    : public Eigen::Matrix<double, 6, 6> {
public:
  ...
  EIGEN_STRONG_INLINE
  SpatialMatrix_t(const Scalar &m00, const Scalar &m01, const Scalar &m02,
    ...
    (*this) << m00, m01, m02, m03, m04, m05, m10, m11, m12, m13, m14, m15, m20,
        m21, m22, m23, m24, m25, m30, m31, m32, m33, m34, m35, m40, m41, m42,
        m43, m44, m45, m50, m51, m52, m53, m54, m55;
  }

  void set(const Scalar &m00, const Scalar &m01, const Scalar &m02,
           const Scalar &m03, const Scalar &m04, const Scalar &m05,
           const Scalar &m10, const Scalar &m11, const Scalar &m12,
           const Scalar &m13, const Scalar &m14, const Scalar &m15,
           const Scalar &m20, const Scalar &m21, const Scalar &m22,
