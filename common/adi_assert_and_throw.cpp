...
#include "adi_assertion_error.hpp"
#include "never_destroyed.hpp"
...
extern "C" void adi_set_assertion_failure_to_throw_exception() {
  adi::detail::AssertionConfig::singleton().assertion_failures_are_exceptions =
      true;
}